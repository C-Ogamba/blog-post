...
@bp.route('/blog/<id>/update', methods=['POST'])
@login_required
def blog_update(id):
    form = EditBlogForm()
    blog = Blog.query.get(id)
...
@bp.route('/blog/<id>/update_image', methods=['POST'])
@login_required
...
# comments
@bp.route("/blog/<id>/comment", methods=["POST"])
@login_required
def save_comment(id):
    blog = Blog.query.get(id)
    form = CommentForm()
...
# delete blog
@bp.route("/blog/<id>/delete", methods=["GET"])
@login_required
def delete_blog(id):
    blog = Blog.query.get(id)
